...
const double bandwidth_v_VSI 	= 200;
double Kpi_VSI					= 0;
double Kii_VSI					= 0;
double Kpv_VSI					= 0;
double Kiv_VSI					= 0;
...
const double bandwidth_v_AFE 	= 90;
double Kpi_AFE					= 0;
double Kii_AFE					= 0;
double Kpv_AFE					= 0;
double Kiv_AFE					= 0;
...
// variables for pll
double DEF_pll =30;							//control loop for PLL (Hz)
...
// 	Kiv_VSI			= Two_PI*bandwidth_v_VSI/R_load_VSI;
    Kpi_VSI			= Two_PI*bandwidth_i_VSI*Lout_VSI*0.5;//Two_PI*bandwidth_i_VSI*Lout_VSI*0.5;
	Kii_VSI			= Two_PI*bandwidth_i_VSI*R_Lout_VSI*10;//86.8;//Two_PI*bandwidth_i_VSI*R_Lout_VSI*10;
	Kpv_VSI			= Two_PI*bandwidth_v_VSI*Cout_VSI;//
	Kiv_VSI			= Two_PI*bandwidth_v_VSI/R_load_VSI;//
// calculate AFE PI parameters
	Kpi_AFE			= 30*0.00068;//Two_PI*bandwidth_i_AFE*Lout_AFE;//
	Kii_AFE			= 30;//Two_PI*bandwidth_i_AFE*R_Lout_AFE;//
	Kpv_AFE			= Two_PI*bandwidth_v_AFE*C_dc_AFE*1;
	Kiv_AFE			= 2.5*Two_PI*bandwidth_v_AFE/R_load_AFE*1;
...
//             I_loop_AFE();
    ...
    *y4=DutyA_1;
    *y5=DutyB_1;
    *y6=idref_VSI;//Vd_out_VSI;//DutyC_1;
    *y8=iqref_VSI;//Vq_out_VSI;//FW_VLL[0];
}

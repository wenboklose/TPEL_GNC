 ...
 *
 *        void epwm1_isr(double y1[1], double y2[1], double y3[1], double y4[1], double y5[1], double y6[1], double y7[1], double y8[1], double u1, double u2, double u3, double u4, double u5, double u6, double u7, double u8, double u9, double u10)
 *
 *   Simulink version           : 8.1 (R2013a) 13-Feb-2013
 *   C source code generated on : 22-Oct-2013 20:19:44
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  epwm1_isr( y1, y2, y3, y4, y5, y6, y7, y8, *u1, *u2, *u3, *u4, *u5, *u6, *u7, *
            u8, *u9, *u10);
}

...
const double bandwidth_v_AFE 	= 150;
double Kpi_AFE					= 0;
double Kii_AFE					= 0;
double Kpv_AFE					= 0;
double Kiv_AFE					= 0;
...
// u1 is 
void epwm1_isr(double *y1, double *y2, double *y3, double *y4, double *y5, double *y6, double *y7, double *y8, double u1, double u2, double u3, double u4, double u5, double u6, double u7, double u8, double u9, double u10)
{
...
// 	Kiv_VSI			= Two_PI*bandwidth_v_VSI/R_load_VSI;
    Kpi_VSI			= 86.8*8.3e-5;//Two_PI*bandwidth_i_VSI*Lout_VSI*0.5;//Two_PI*bandwidth_i_VSI*Lout_VSI*0.5;
	Kii_VSI			= 86.8;//Two_PI*bandwidth_i_VSI*R_Lout_VSI*10;//86.8;//Two_PI*bandwidth_i_VSI*R_Lout_VSI*10;
	Kpv_VSI			= 130*2.2e-5;//Two_PI*bandwidth_v_VSI*Cout_VSI;//
	Kiv_VSI			= 130;//Two_PI*bandwidth_v_VSI/R_load_VSI;//
// calculate AFE PI parameters
	Kpi_AFE			= Two_PI*bandwidth_i_AFE*Lout_AFE;//35.321*0.00068;//
	Kii_AFE			= 20*Two_PI*bandwidth_i_AFE*R_Lout_AFE;//35.321;//
	Kpv_AFE			= Two_PI*bandwidth_v_AFE*C_dc_AFE*1;
	Kiv_AFE			= 1*Two_PI*bandwidth_v_AFE/R_load_AFE*1;
...
//             I_loop_AFE();
    ...
    SVM();
    *y1=Id_AFE;//Vd_out_AFE;//DutyA_2;
    *y2=Iq_AFE;//Vq_out_AFE;//DutyB_2;
    *y3=DutyC_2;
    *y4=DutyA_1;
    *y5=DutyB_1;
    *y6=DutyC_1;
...
// 	}
	...
	Mk_2					= out_vector_beta_VSI*SQRT_1over2;///Vdc_VSI;	
...
// 	VLL_q_AFE 			= -SIN_VLL_theta_AFE*VLL_alpha_AFE+COS_VLL_theta_AFE*VLL_beta_AFE;
	...
	VLL_DQ_theta_AFE 	= VLL_DQ_theta_AFE+(FW_VLL[0]+f_line*2*PI)*Tsw_AFE;
